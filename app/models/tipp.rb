class Tipp < ActiveRecord::Base
  ...
  validates :home_goals, :numericality => { :greater_than_or_equal_to => 0, :less_than_or_equal_to => 15, :message => "Die Zahl der geschossenen Tore muss zwischen 0 und 20 liegen." }
  validates :away_goals, :numericality => { :greater_than_or_equal_to => 0, :less_than_or_equal_to => 15, :message => "Die Zahl der geschossenen Tore muss zwischen 0 und 20 liegen." }
